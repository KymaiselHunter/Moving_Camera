...
## Arduino Hardware
  -  [ELEGOO UNO R3 Board ATmega328P with USB Cable(Arduino-Compatible) for Arduino](ELEGOO UNO R3 Board ATmega328P with USB Cable(Arduino-Compatible) for Arduino)
